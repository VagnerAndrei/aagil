...
export class HomeView extends View {
	...
	_init() {
		...
		//TODO:
		this._buttonPostar.addEventListener('click', () => postagem({event: 'clickEvent'}))
		this._postagens = new PostagemListaController({ element: 'section-postagens' })
		this.applyRole()
	}
